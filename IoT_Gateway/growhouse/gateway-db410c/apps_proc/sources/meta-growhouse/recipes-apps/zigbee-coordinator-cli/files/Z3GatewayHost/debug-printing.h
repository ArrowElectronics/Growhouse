...
// Printing macros for cluster: pH Measurement
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PH_MEASUREMENT_CLUSTER)
#define emberAfPhMeasurementClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_PH_MEASUREMENT_CLUSTER, __VA_ARGS__)
#define emberAfPhMeasurementClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PH_MEASUREMENT_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPhMeasurementClusterFlush()
#define emberAfPhMeasurementClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PH_MEASUREMENT_CLUSTER) ) { x; }
#define emberAfPhMeasurementClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PH_MEASUREMENT_CLUSTER, (buffer), (len), (withSpace))
#define emberAfPhMeasurementClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PH_MEASUREMENT_CLUSTER, (buffer))
#else
#define emberAfPhMeasurementClusterPrint(...)
#define emberAfPhMeasurementClusterPrintln(...)
#define emberAfPhMeasurementClusterFlush()
#define emberAfPhMeasurementClusterDebugExec(x)
#define emberAfPhMeasurementClusterPrintBuffer(buffer, len, withSpace)
#define emberAfPhMeasurementClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PH_MEASUREMENT_CLUSTER)


// Printing macros for cluster: Soil Moisture Measurement
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SOIL_MOISTURE_MEASUREMENT_CLUSTER)
#define emberAfSoilMoistureMeasurementClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_SOIL_MOISTURE_MEASUREMENT_CLUSTER, __VA_ARGS__)
#define emberAfSoilMoistureMeasurementClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_SOIL_MOISTURE_MEASUREMENT_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfSoilMoistureMeasurementClusterFlush()
#define emberAfSoilMoistureMeasurementClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_SOIL_MOISTURE_MEASUREMENT_CLUSTER) ) { x; }
#define emberAfSoilMoistureMeasurementClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_SOIL_MOISTURE_MEASUREMENT_CLUSTER, (buffer), (len), (withSpace))
#define emberAfSoilMoistureMeasurementClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_SOIL_MOISTURE_MEASUREMENT_CLUSTER, (buffer))
#else
#define emberAfSoilMoistureMeasurementClusterPrint(...)
#define emberAfSoilMoistureMeasurementClusterPrintln(...)
#define emberAfSoilMoistureMeasurementClusterFlush()
#define emberAfSoilMoistureMeasurementClusterDebugExec(x)
#define emberAfSoilMoistureMeasurementClusterPrintBuffer(buffer, len, withSpace)
#define emberAfSoilMoistureMeasurementClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_SOIL_MOISTURE_MEASUREMENT_CLUSTER)


// Printing macros for cluster: RGB Intensity Measurement
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_RGB_INTENSITY_MEASUREMENT_CLUSTER)
#define emberAfRgbIntensityMeasurementClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_RGB_INTENSITY_MEASUREMENT_CLUSTER, __VA_ARGS__)
#define emberAfRgbIntensityMeasurementClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_RGB_INTENSITY_MEASUREMENT_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfRgbIntensityMeasurementClusterFlush()
#define emberAfRgbIntensityMeasurementClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_RGB_INTENSITY_MEASUREMENT_CLUSTER) ) { x; }
#define emberAfRgbIntensityMeasurementClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_RGB_INTENSITY_MEASUREMENT_CLUSTER, (buffer), (len), (withSpace))
#define emberAfRgbIntensityMeasurementClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_RGB_INTENSITY_MEASUREMENT_CLUSTER, (buffer))
#else
#define emberAfRgbIntensityMeasurementClusterPrint(...)
#define emberAfRgbIntensityMeasurementClusterPrintln(...)
#define emberAfRgbIntensityMeasurementClusterFlush()
#define emberAfRgbIntensityMeasurementClusterDebugExec(x)
#define emberAfRgbIntensityMeasurementClusterPrintBuffer(buffer, len, withSpace)
#define emberAfRgbIntensityMeasurementClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_RGB_INTENSITY_MEASUREMENT_CLUSTER)
