...
#if     (COEX_REQ_SUPPORT || COEX_RHO_SUPPORT)
...
static void eventsCb(COEX_Events_t events)
{
  ...
  } else if (events & COEX_EVENT_HOLDOFF_DISABLED) {
...
#else//!(COEX_REQ_SUPPORT || COEX_RHO_SUPPORT)
...
#endif//(COEX_REQ_SUPPORT || COEX_RHO_SUPPORT)
...
#endif//COEX_REQ_SUPPORT

#if     USE_MULTITIMER && COEX_REQ_SUPPORT
...
#else//!(USE_MULTITIMER && COEX_REQ_SUPPORT)
...
#endif//(USE_MULTITIMER && COEX_REQ_SUPPORT)
