...
#define microphoneEnable()  do { GPIO->P[0].SET = _GPIO_P_SET_Px6_MASK; } while (0)
#define microphoneDisable() do { GPIO->P[0].CLR = _GPIO_P_CLR_Px6_MASK; } while (0)
...
#define DEFINE_POWERUP_GPIO_CFG_VARIABLES()                           \
  uint16_t gpioCfgPowerUp[6] = {                                      \
    ((GPIO_P_CFGL_Px0_IN_PUD)      /* NOT USED */                     \
     | (GPIO_P_CFGL_Px1_OUT)       /* KEY_COL6 / AUDIO_MCLK  */       \
     | (GPIO_P_CFGL_Px2_OUT)       /* KEY_COL4 / AUDIO_BCLK */        \
     | (GPIO_P_CFGL_Px3_OUT)),     /* KEY_COL2 / AUDIO_WCLK  */       \
    ((GPIO_P_CFGH_Px4_OUT)         /* KEY_BACKLIGHT */                \
     | (GPIO_P_CFGH_Px5_OUT)       /* PWR_BACKLIGHT */                \
     | (GPIO_P_CFGH_Px6_OUT)       /* MICROPHONE ENABLE */            \
     | (GPIO_P_CFGH_Px7_OUT_ALT)), /* BUZZER */                       \
    ((GPIO_P_CFGL_Px0_IN_PUD)      /* KEY_ROW4 */                     \
     | (GPIO_P_CFGL_Px1_IN)        /* SC1TXD / SDA */                 \
     | (GPIO_P_CFGL_Px2_IN)        /* SC1RXD / SCL */                 \
     | (GPIO_P_CFGL_Px3_OUT)),     /* IR2 */                          \
    ((GPIO_P_CFGH_Px4_IN_PUD)      /* KEY_ROW1 */                     \
     | (GPIO_P_CFGH_Px5_IN)        /* ACC_INT */                      \
     | (GPIO_P_CFGH_Px6_OUT)       /* IR1 */                          \
     | (GPIO_P_CFGH_Px7_IN_PUD)),  /* KEY_ROW6 */                     \
    ((GPIO_P_CFGL_Px0_IN)          /* KEY_ROW5 / JTAG_JRST */         \
     | (GPIO_P_CFGL_Px1_IN_PUD)    /* KEY_ROW2 */                     \
    ...
    ((GPIO_P_CFGH_Px4_IN)          /* KEY_ROW3 / JTAG_JTMS / SWDIO */ \
     | (GPIO_P_CFGH_Px5_IN_PUD)        /* KEY_ROW0 */                 \
     | (GPIO_P_CFGH_Px6_OUT)       /* KEY_COL0 */                     \
     | (GPIO_P_CFGH_Px7_OUT))      /* KEY_COL1 */                     \
  }
...
#define DEFINE_POWERUP_GPIO_OUTPUT_DATA_VARIABLES()                                          \
  uint8_t gpioOutPowerUp[3] = {                                                              \
    ((GPIO_P_OUT_Pxy_PULLDOWN << _GPIO_P_OUT_Px0_SHIFT)   /* NOT USED */                     \
     | (0                     << _GPIO_P_OUT_Px1_SHIFT)   /* KEY_COL6 / AUDIO_MCLK  */       \
     | (0                     << _GPIO_P_OUT_Px2_SHIFT)   /* KEY_COL4 / AUDIO_BCLK */        \
     | (0                     << _GPIO_P_OUT_Px3_SHIFT)   /* KEY_COL2 / AUDIO_WCLK  */       \
     | (0                     << _GPIO_P_OUT_Px4_SHIFT)   /* KEY_BACKLIGHT */                \
     | (0                     << _GPIO_P_OUT_Px5_SHIFT)   /* PWR_BACKLIGHT */                \
     | (0                     << _GPIO_P_OUT_Px6_SHIFT)   /* MICROPHONE ENABLE*/             \
     | (0                     << _GPIO_P_OUT_Px7_SHIFT)), /* BUZZER */                       \
    ((GPIO_P_OUT_Pxy_PULLUP   << _GPIO_P_OUT_Px0_SHIFT)   /* KEY_ROW4 */                     \
     | (1                     << _GPIO_P_OUT_Px1_SHIFT)   /* SC1TXD / SDA */                 \
     | (1                     << _GPIO_P_OUT_Px2_SHIFT)   /* SC1RXD / SCL */                 \
     | (0                     << _GPIO_P_OUT_Px3_SHIFT)   /* IR2 */                          \
     | (GPIO_P_OUT_Pxy_PULLUP << _GPIO_P_OUT_Px4_SHIFT)   /* KEY_ROW1 */                     \
     | (0                     << _GPIO_P_OUT_Px5_SHIFT)   /* ACC_INT */                      \
     | (0                     << _GPIO_P_OUT_Px6_SHIFT)   /* IR1 */                          \
     | (GPIO_P_OUT_Pxy_PULLUP << _GPIO_P_OUT_Px7_SHIFT)), /* KEY_ROW6 */                     \
    ((0                       << _GPIO_P_OUT_Px0_SHIFT)   /* KEY_ROW5 / JTAG_JRST */         \
     | (GPIO_P_OUT_Pxy_PULLUP << _GPIO_P_OUT_Px1_SHIFT)   /* KEY_ROW2 */                     \
     ...
     | (GPIO_P_OUT_Pxy_PULLUP << _GPIO_P_OUT_Px5_SHIFT)   /* KEY_ROW0 */                     \
     | (0                     << _GPIO_P_OUT_Px6_SHIFT)   /* KEY_COL0 */                     \
     | (0                     << _GPIO_P_OUT_Px7_SHIFT))  /* KEY_COL1 */                     \
  }
