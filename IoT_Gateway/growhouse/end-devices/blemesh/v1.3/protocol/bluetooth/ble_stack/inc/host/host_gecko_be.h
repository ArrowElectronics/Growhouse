...
static inline struct gecko_msg_le_gap_set_phy_rsp_t* gecko_cmd_le_gap_set_phy(uint8 phy)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_le_gap_set_phy_id+((1)<<8)));
...
static inline struct gecko_msg_le_gap_set_advertise_tx_power_rsp_t* gecko_cmd_le_gap_set_advertise_tx_power(uint8 handle,int8 power)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_le_gap_set_advertise_tx_power_id+((2)<<8)));
...
static inline struct gecko_msg_gatt_server_set_database_rsp_t* gecko_cmd_gatt_server_set_database(uint32 ptr)
{
    ...
    gecko_cmd_msg->data.cmd_gatt_server_set_database.ptr=SL_BT_SWAP32(ptr);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_gatt_server_set_database_id+((4)<<8)));
...
static inline struct gecko_msg_endpoint_close_rsp_t* gecko_cmd_endpoint_close(uint8 endpoint)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_endpoint_close_id+((1)<<8)));
...
static inline struct gecko_msg_hardware_enable_dcdc_rsp_t* gecko_cmd_hardware_enable_dcdc(uint8 enable)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_hardware_enable_dcdc_id+((1)<<8)));
...
static inline struct gecko_msg_test_debug_command_rsp_t* gecko_cmd_test_debug_command(uint8 id,uint8 debugdata_len, const uint8* debugdata_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_test_debug_command_id+((2+debugdata_len)<<8)));
...
static inline struct gecko_msg_test_debug_counter_rsp_t* gecko_cmd_test_debug_counter(uint32 id)
{
    ...
    gecko_cmd_msg->data.cmd_test_debug_counter.id=SL_BT_SWAP32(id);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_test_debug_counter_id+((4)<<8)));
...
static inline struct gecko_msg_homekit_configure_rsp_t* gecko_cmd_homekit_configure(uint8 i2c_address,uint8 support_display,uint8 hap_attribute_features,uint16 category,uint8 configuration_number,uint16 fast_advert_interval,uint16 fast_advert_timeout,uint32 flag,uint16 broadcast_advert_timeout)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_homekit_configure_id+((16)<<8)));
...
static inline struct gecko_msg_mesh_debug_dump_keys_rsp_t* gecko_cmd_mesh_debug_dump_keys(uint8 node_handle)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_dump_keys_id+((1)<<8)));
...
static inline struct gecko_msg_mesh_debug_prov_dump_database_rsp_t* gecko_cmd_mesh_debug_prov_dump_database()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_prov_dump_database_id+((0)<<8)));
...
static inline struct gecko_msg_mesh_debug_prov_load_database_entries_rsp_t* gecko_cmd_mesh_debug_prov_load_database_entries(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_prov_load_database_entries_id+((1+data_len)<<8)));
...
static inline struct gecko_msg_mesh_debug_set_mask_rsp_t* gecko_cmd_mesh_debug_set_mask(uint16 mask)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_set_mask.mask=SL_BT_SWAP16(mask);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_set_mask_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_debug_set_kludges_rsp_t* gecko_cmd_mesh_debug_set_kludges(uint16 mask)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_set_kludges.mask=SL_BT_SWAP16(mask);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_set_kludges_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_debug_rssi_limit_set_rsp_t* gecko_cmd_mesh_debug_rssi_limit_set(int8 rssi)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_rssi_limit_set_id+((1)<<8)));
...
static inline struct gecko_msg_mesh_debug_add_va_rsp_t* gecko_cmd_mesh_debug_add_va(uint8 label_len, const uint8* label_data)
{
    struct gecko_cmd_packet *gecko_cmd_msg = (struct gecko_cmd_packet *)gecko_cmd_msg_buf;
    struct gecko_cmd_packet *gecko_rsp_msg = (struct gecko_cmd_packet *)gecko_rsp_msg_buf;
    if ((uint16_t)label_len > BGLIB_MSG_MAX_PAYLOAD - 1)
    {
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_add_va_id+((1+label_len)<<8)));
...
static inline struct gecko_msg_mesh_debug_unref_va_rsp_t* gecko_cmd_mesh_debug_unref_va(int8 index)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_unref_va_id+((1)<<8)));
...
static inline struct gecko_msg_mesh_debug_dump_va_rsp_t* gecko_cmd_mesh_debug_dump_va()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_dump_va_id+((0)<<8)));
...
static inline struct gecko_msg_mesh_debug_set_white_list_item_rsp_t* gecko_cmd_mesh_debug_set_white_list_item(uint8 index,bd_addr mac)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_set_white_list_item_id+((7)<<8)));
...
static inline struct gecko_msg_mesh_debug_set_white_list_active_rsp_t* gecko_cmd_mesh_debug_set_white_list_active(uint8 status)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_set_white_list_active_id+((1)<<8)));
...
static inline struct gecko_msg_mesh_debug_node_set_static_oob_data_rsp_t* gecko_cmd_mesh_debug_node_set_static_oob_data(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_node_set_static_oob_data_id+((1+data_len)<<8)));
...
static inline struct gecko_msg_mesh_debug_node_set_oob_eckey_rsp_t* gecko_cmd_mesh_debug_node_set_oob_eckey(uint8 key_len, const uint8* key_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_node_set_oob_eckey_id+((1+key_len)<<8)));
...
static inline struct gecko_msg_mesh_debug_node_get_oob_eckey_rsp_t* gecko_cmd_mesh_debug_node_get_oob_eckey()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_node_get_oob_eckey_id+((0)<<8)));
...
static inline struct gecko_msg_mesh_debug_node_get_static_oob_data_rsp_t* gecko_cmd_mesh_debug_node_get_static_oob_data()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_node_get_static_oob_data_id+((0)<<8)));
...
static inline struct gecko_msg_mesh_debug_network_trace_config_rsp_t* gecko_cmd_mesh_debug_network_trace_config(uint16 events)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_network_trace_config.events=SL_BT_SWAP16(events);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_network_trace_config_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_debug_network_update_rsp_t* gecko_cmd_mesh_debug_network_update(uint16 address,uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_network_update.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_debug_network_update.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_network_update_id+((4)<<8)));
...
static inline struct gecko_msg_mesh_debug_appkey_update_rsp_t* gecko_cmd_mesh_debug_appkey_update(uint16 address,uint16 netkey_index,uint16 appkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_appkey_update.address=SL_BT_SWAP16(address);
    gecko_cmd_msg->data.cmd_mesh_debug_appkey_update.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->data.cmd_mesh_debug_appkey_update.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_appkey_update_id+((6)<<8)));
...
static inline struct gecko_msg_mesh_debug_proxy_listen_rsp_t* gecko_cmd_mesh_debug_proxy_listen()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_proxy_listen_id+((0)<<8)));
...
static inline struct gecko_msg_mesh_debug_set_scan_rsp_t* gecko_cmd_mesh_debug_set_scan(uint8 state)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_set_scan_id+((1)<<8)));
...
static inline struct gecko_msg_mesh_debug_node_set_oob_uri_rsp_t* gecko_cmd_mesh_debug_node_set_oob_uri(uint8 uri_len, const uint8* uri_data)
{
    struct gecko_cmd_packet *gecko_cmd_msg = (struct gecko_cmd_packet *)gecko_cmd_msg_buf;
    struct gecko_cmd_packet *gecko_rsp_msg = (struct gecko_cmd_packet *)gecko_rsp_msg_buf;
    if ((uint16_t)uri_len > BGLIB_MSG_MAX_PAYLOAD - 1)
    {
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_node_set_oob_uri_id+((1+uri_len)<<8)));
...
static inline struct gecko_msg_mesh_debug_node_get_oob_uri_rsp_t* gecko_cmd_mesh_debug_node_get_oob_uri()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_node_get_oob_uri_id+((0)<<8)));
...
static inline struct gecko_msg_mesh_debug_node_init_cfgcl_rsp_t* gecko_cmd_mesh_debug_node_init_cfgcl()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_node_init_cfgcl_id+((0)<<8)));
...
static inline struct gecko_msg_mesh_debug_key_refresh_start_noauto_rsp_t* gecko_cmd_mesh_debug_key_refresh_start_noauto(uint16 netkey_index,uint8 num_appkeys,uint8 appkey_indices_len, const uint8* appkey_indices_data)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_key_refresh_start_noauto.netkey_index=SL_BT_SWAP16(netkey_index);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_key_refresh_start_noauto_id+((4+appkey_indices_len)<<8)));
...
static inline struct gecko_msg_mesh_debug_key_refresh_next_phase_rsp_t* gecko_cmd_mesh_debug_key_refresh_next_phase(uint16 netkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_key_refresh_next_phase.netkey_index=SL_BT_SWAP16(netkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_key_refresh_next_phase_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_debug_net_send_rsp_t* gecko_cmd_mesh_debug_net_send(uint16 key,uint16 element_index,uint16 dst,uint8 ttl,uint8 ctl,uint8 message_len, const uint8* message_data)
{
    struct gecko_cmd_packet *gecko_cmd_msg = (struct gecko_cmd_packet *)gecko_cmd_msg_buf;
    struct gecko_cmd_packet *gecko_rsp_msg = (struct gecko_cmd_packet *)gecko_rsp_msg_buf;
    if ((uint16_t)message_len > BGLIB_MSG_MAX_PAYLOAD - 9)
    {
    ...
    gecko_cmd_msg->data.cmd_mesh_debug_net_send.key=SL_BT_SWAP16(key);
    gecko_cmd_msg->data.cmd_mesh_debug_net_send.element_index=SL_BT_SWAP16(element_index);
    gecko_cmd_msg->data.cmd_mesh_debug_net_send.dst=SL_BT_SWAP16(dst);
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_debug_net_send_id+((9+message_len)<<8)));
...
static inline struct gecko_msg_proxy_radio_proxy_send_adv_rsp_t* gecko_cmd_proxy_radio_proxy_send_adv(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_proxy_radio_proxy_send_adv_id+((1+data_len)<<8)));
...
static inline struct gecko_msg_proxy_radio_child_adv_req_done_rsp_t* gecko_cmd_proxy_radio_child_adv_req_done(uint16 result)
{
    ...
    gecko_cmd_msg->data.cmd_proxy_radio_child_adv_req_done.result=SL_BT_SWAP16(result);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_proxy_radio_child_adv_req_done_id+((2)<<8)));
...
static inline struct gecko_msg_proxy_radio_child_adv_data_rsp_t* gecko_cmd_proxy_radio_child_adv_data(uint8 data_len, const uint8* data_data)
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_proxy_radio_child_adv_data_id+((1+data_len)<<8)));
...
static inline struct gecko_msg_proxy_radio_get_ms_ticks_rsp_t* gecko_cmd_proxy_radio_get_ms_ticks()
{
    ...
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_proxy_radio_get_ms_ticks_id+((0)<<8)));
...
static inline struct gecko_msg_proxy_radio_test_timer_rsp_t* gecko_cmd_proxy_radio_test_timer(uint32 ms)
{
    ...
    gecko_cmd_msg->data.cmd_proxy_radio_test_timer.ms=SL_BT_SWAP32(ms);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_proxy_radio_test_timer_id+((4)<<8)));
...
static inline struct gecko_msg_mesh_srtest_client_init_rsp_t* gecko_cmd_mesh_srtest_client_init(uint16 elem_index,uint16 packet_size,uint8 force_segmentation,uint32 packet_rate,uint32 run_length)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_client_init.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_init.packet_size=SL_BT_SWAP16(packet_size);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_init.force_segmentation=(force_segmentation);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_init.packet_rate=SL_BT_SWAP32(packet_rate);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_init.run_length=SL_BT_SWAP32(run_length);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_client_init_id+((13)<<8)));
...
static inline struct gecko_msg_mesh_srtest_client_deinit_rsp_t* gecko_cmd_mesh_srtest_client_deinit(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_client_deinit.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_client_deinit_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_srtest_client_run_rsp_t* gecko_cmd_mesh_srtest_client_run(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 tid)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_client_run.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_run.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_run.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_run.tid=(tid);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_client_run_id+((7)<<8)));
...
static inline struct gecko_msg_mesh_srtest_client_stop_rsp_t* gecko_cmd_mesh_srtest_client_stop(uint16 elem_index,uint16 server_address,uint16 appkey_index,uint8 tid)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_client_stop.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_stop.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_stop.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_stop.tid=(tid);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_client_stop_id+((7)<<8)));
...
static inline struct gecko_msg_mesh_srtest_client_status_rsp_t* gecko_cmd_mesh_srtest_client_status(uint16 elem_index,uint16 server_address,uint16 appkey_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_client_status.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_status.server_address=SL_BT_SWAP16(server_address);
    gecko_cmd_msg->data.cmd_mesh_srtest_client_status.appkey_index=SL_BT_SWAP16(appkey_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_client_status_id+((6)<<8)));
...
static inline struct gecko_msg_mesh_srtest_client_statistics_rsp_t* gecko_cmd_mesh_srtest_client_statistics(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_client_statistics.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_client_statistics_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_srtest_server_init_rsp_t* gecko_cmd_mesh_srtest_server_init(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_server_init.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_server_init_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_srtest_server_deinit_rsp_t* gecko_cmd_mesh_srtest_server_deinit(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_server_deinit.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_server_deinit_id+((2)<<8)));
...
static inline struct gecko_msg_mesh_srtest_server_statistics_rsp_t* gecko_cmd_mesh_srtest_server_statistics(uint16 elem_index)
{
    ...
    gecko_cmd_msg->data.cmd_mesh_srtest_server_statistics.elem_index=SL_BT_SWAP16(elem_index);
    gecko_cmd_msg->header=SL_BT_SWAP32((gecko_cmd_mesh_srtest_server_statistics_id+((2)<<8)));
