...
//FACTORY_RESET_BUTTON enable
#define FACTORY_RESET_BUTTON (1)

#ifdef FACTORY_RESET_BUTTON
#define BSP_BUTTON_FACTORY_RESET_PIN                               (5U)
#define BSP_BUTTON_FACTORY_RESET_PORT                              (gpioPortA)
#else
#define BSP_BUTTON_FACTORY_RESET_PIN                               (11U)
#define BSP_BUTTON_FACTORY_RESET_PORT                              (gpioPortC)
...
// $[Zigbee SERIAL]
#define BSP_ZIGBEE_SERIAL_APP_PORT                           (HAL_SERIAL_PORT_USART2)
#define BSP_ZIGBEE_SERIAL_APP_CTS_PIN                        (7U)
#define BSP_ZIGBEE_SERIAL_APP_CTS_PORT                       (gpioPortF)
#define BSP_ZIGBEE_SERIAL_APP_CTS_LOC                        (16U)

#define BSP_ZIGBEE_SERIAL_APP_RX_PIN                         (5U)
#define BSP_ZIGBEE_SERIAL_APP_RX_PORT                        (gpioPortF)
#define BSP_ZIGBEE_SERIAL_APP_RX_LOC                         (17U)

#define BSP_ZIGBEE_SERIAL_APP_TX_PIN                         (4U)
#define BSP_ZIGBEE_SERIAL_APP_TX_PORT                        (gpioPortF)
#define BSP_ZIGBEE_SERIAL_APP_TX_LOC                         (17U)

#define BSP_ZIGBEE_SERIAL_APP_RTS_PIN                        (6U)
#define BSP_ZIGBEE_SERIAL_APP_RTS_PORT                       (gpioPortF)
#define BSP_ZIGBEE_SERIAL_APP_RTS_LOC                        (14U)
...
#define HAL_USART2_FLOW_CONTROL                      (HAL_USART_FLOW_CONTROL_HWUART)

#define HAL_ZIGBEE_CONN_PIN						 	 (14U)
#define HAL_ZIGBEE_CONN_PORT						 (gpioPortD)

#define HAL_IN_BLE_PIN						 	 	 (15U)
#define HAL_IN_BLE_PORT						 		 (gpioPortD)
// [USART2 - ZIGBEE]$

// $[DIGITAL POTENTIOMETER]
#define AD5206_PIN_CS                           (10U)
#define AD5206_PORT_CS                          (gpioPortC)

#define AD5206_PIN_SCLK                         (8U)
#define AD5206_PORT_SCLK                        (gpioPortC)
#define AD5206_LOC_SCLK                         (11U)

#define AD5206_PIN_MISO                         (7U)
#define AD5206_PORT_MISO                        (gpioPortC)
#define AD5206_LOC_RX                           (11U)

#define AD5206_PIN_MOSI                         (6U)
#define AD5206_PORT_MOSI                        (gpioPortC)
#define AD5206_LOC_TX                           (11U)

#define AD5206_USART              				USART1
#define AD5206_USART_CLK          				cmuClock_USART1

#define AD5206_BAUDRATE          	 			(1000000)
// [DIGITAL POTENTIOMETER]$
