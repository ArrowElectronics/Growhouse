...
echo " "
"${COMMANDER}" convert "/home/keval/GrowHouse/Studio/SimplicityStudio_v4/developer/sdks/growhouse/end-devices/blemesh/v1.3/platform/bootloader/build/first_stage/gcc/first_stage_btl_efx32xg13.s37" "${FILENAME}.s37" -o "${FILENAME}-combined.s37"
