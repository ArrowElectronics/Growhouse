...
*
* @param    in              Pointer to a CPU_CHAR string holding a complete command and its
...
*
* @param    in              Pointer to a NULL terminated string holding a complete command and its
*                           argument(s).
*
