...
void BSP_RTCC_TickInit(void)
{
  ...
  init.enable = false;
  init.presc  = (RTCC_CntPresc_TypeDef) divToLog2(RTCC_PRESCALER);


  CMU_ClockEnable(cmuClock_RTCC, true);
  CMU_ClockSelectSet(cmuClock_RTCC, RTCC_CLOCK);
...
*********************************************************************************************************
*                                          divToLog2()
* Description : Convert dividend to prescaler logarithmic value. Only works for even
*               numbers equal to 2^n.
*
* Argument(s) : div  Unscaled dividend.
*
* Return(s)   : Base 2 logarithm of input.
*********************************************************************************************************
*/
...
__STATIC_INLINE uint32_t divToLog2(uint32_t div)
{
  ...
  /* Count leading zeroes and "reverse" result, Cortex-M33 intrinsic */
  log2 = (31 - __CLZ(div));
