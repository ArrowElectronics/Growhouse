...
def calculate_memory_usage(dcd, memcfg, memsizes):
    ...
    total += memcfg.provisioned_devices * (memsizes['prv_ddb_entry_base'] + memcfg.provisioned_device_max_netkeys * memsizes['prv_ddb_entry_per_node_netkey'] + memcfg.provisioned_device_max_appkeys * memsizes['prv_ddb_entry_per_node_appkey'])
    return total
