...
class ble_mesh_NetworkAppUITests: XCTestCase {
    ...
    func testNavigatingToAndFromNetwork() {
        ...
        let app = XCUIApplication()
        XCUIApplication().tables/*@START_MENU_TOKEN@*/.otherElements["network field"]/*[[".cells.otherElements[\"network field\"]",".otherElements[\"network field\"]"],[[[-1,1],[-1,0]]],[0]]@END_MENU_TOKEN@*/.tap()
