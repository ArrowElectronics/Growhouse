...
class GroupMasterControlViewController: UIViewController {
    ...
    @IBAction private func switchToggled(_ sender: UIButton) {
        ...
        NotificationCenter.default.post(name: BluetoothMeshNotifications.GroupValueChanged, object: nil, userInfo: ["value" : viewModel!.isOn ? 1.0 : 0.0])
    }
    ...
    @IBAction private func sliderValueChanged(_ sender: UISlider) {
        ...
        NotificationCenter.default.post(name: BluetoothMeshNotifications.GroupValueChanged, object: nil, userInfo: ["value" : Double(sender.value)])
    }
