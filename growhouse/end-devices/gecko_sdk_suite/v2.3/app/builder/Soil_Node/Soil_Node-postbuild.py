...
def S37():
    ...
    if ("gcc" == "iar" or "gcc" == ""):
        ...
        GCC_TOOLCHAIN_PATH = shortPath(r"file:/home/dhaval/projects/grow_house/studio/SimplicityStudio_v4/developer/toolchains/gnu_arm/7.2_2017q4/".replace(
            "file:", "").replace("%20", " "))
...
def EBL():
    ...
    print " "
    EBL_COMMAND = START_FLAGS + shortPath(r"/home/dhaval/projects/grow_house/studio/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
...
def GBL():
    ...
    GBL_COMMAND = START_FLAGS + shortPath(r"/home/dhaval/projects/grow_house/studio/SimplicityStudio_v4/developer/adapter_packs/commander/commander").replace(
...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 6 --manuf-id 0x0 --image-type 114 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL Soil_Node"':
        sys.exit(0)
    print " "
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 6 --manuf-id 0x0 --image-type 114 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL Soil_Node"'.replace("\t", "\\t")
