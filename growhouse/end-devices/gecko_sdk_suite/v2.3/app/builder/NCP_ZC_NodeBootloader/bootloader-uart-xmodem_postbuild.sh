...
if [ -z "${PATH_SCMD}" ]; then
  COMMANDER="/home/keval/GrowHouse/Studio/SimplicityStudio_v4/developer/adapter_packs/commander/commander"
...
echo " "
"${COMMANDER}" convert "/home/keval/GrowHouse/Studio/SimplicityStudio_v4/developer/sdks/growhouse/end-devices/gecko_sdk_suite/v2.3/platform/bootloader/build/first_stage/gcc/first_stage_btl_efx32xg13.s37" "${FILENAME}.s37" -o "${FILENAME}-combined.s37"
