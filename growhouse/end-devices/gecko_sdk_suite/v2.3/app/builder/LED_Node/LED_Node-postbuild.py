...
def OTA():
    if not '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 4 --manuf-id 0x0 --image-type 115 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL LED_Node"':
        sys.exit(0)
    print " "
    ...
    IMAGE_BUILDER = '"%PROJECT_DIR%\..\\..\\..\\protocol\\zigbee\\tool\\image-builder\\image-builder-windows.exe" --create "%TARGET_BPATH%.ota" --version 4 --manuf-id 0x0 --image-type 115 --tag-id 0x0000 --tag-file "%TARGET_BPATH%.gbl" --string "EBL LED_Node"'.replace("\t", "\\t")
