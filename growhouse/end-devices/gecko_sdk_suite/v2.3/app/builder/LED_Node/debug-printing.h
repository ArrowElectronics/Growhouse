...
// Printing macros for cluster: pH Moisture Measurement
#if defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PH_MOISTURE_MEASUREMENT_CLUSTER)
#define emberAfPhMoistureMeasurementClusterPrint(...) emberAfPrint(EMBER_AF_PRINT_PH_MOISTURE_MEASUREMENT_CLUSTER, __VA_ARGS__)
#define emberAfPhMoistureMeasurementClusterPrintln(...) emberAfPrintln(EMBER_AF_PRINT_PH_MOISTURE_MEASUREMENT_CLUSTER,  __VA_ARGS__)
// Blocking IO is enabled for all serial ports, therefore flush calls are unnecessary.
#define emberAfPhMoistureMeasurementClusterFlush()
#define emberAfPhMoistureMeasurementClusterDebugExec(x) if ( emberAfPrintEnabled(EMBER_AF_PRINT_PH_MOISTURE_MEASUREMENT_CLUSTER) ) { x; }
#define emberAfPhMoistureMeasurementClusterPrintBuffer(buffer, len, withSpace) emberAfPrintBuffer(EMBER_AF_PRINT_PH_MOISTURE_MEASUREMENT_CLUSTER, (buffer), (len), (withSpace))
#define emberAfPhMoistureMeasurementClusterPrintString(buffer) emberAfPrintString(EMBER_AF_PRINT_PH_MOISTURE_MEASUREMENT_CLUSTER, (buffer))
#else
#define emberAfPhMoistureMeasurementClusterPrint(...)
#define emberAfPhMoistureMeasurementClusterPrintln(...)
#define emberAfPhMoistureMeasurementClusterFlush()
#define emberAfPhMoistureMeasurementClusterDebugExec(x)
#define emberAfPhMoistureMeasurementClusterPrintBuffer(buffer, len, withSpace)
#define emberAfPhMoistureMeasurementClusterPrintString(buffer)
#endif //defined(EMBER_AF_PRINT_ENABLE) && defined(EMBER_AF_PRINT_PH_MOISTURE_MEASUREMENT_CLUSTER)
