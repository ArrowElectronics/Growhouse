...
#if defined(_USB_GNPTXFSIZ_NPTXFDEP_MASK)
  USB->GNPTXFSIZ = ( (depth << _USB_GNPTXFSIZ_NPTXFDEP_SHIFT)
                     & _USB_GNPTXFSIZ_NPTXFDEP_MASK)
