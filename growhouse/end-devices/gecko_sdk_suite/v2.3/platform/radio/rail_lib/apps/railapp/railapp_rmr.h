...
#define RMR_CI_COMMANDS                                                                                                                                                       \
  COMMAND_SEPARATOR("RAM Modem Reconfiguration Commands"),                                                                                                                    \
  COMMAND_ENTRY("writeRmrStructure", "uvuw*", CI_writeRmrStructure, "This command should only be called by Simplicity Studio and not directly from the CI."),                 \
  COMMAND_ENTRY("updateConfigurationPointer", "uvu", CI_updateConfigurationPointer, "This command should only be called by Simplicity Studio and not directly from the CI."), \
  COMMAND_ENTRY("reconfigureModem", "", CI_reconfigureModem, "This command should only be called by Simplicity Studio and not directly from the CI."),                        \
  COMMAND_SEPARATOR("End of RAM Modem Reconfiguration Commands")
